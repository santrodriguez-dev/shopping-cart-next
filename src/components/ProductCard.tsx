  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
      <div className="h-56 w-full">
        <a href="#">
          {product.images.length === 0 ? <img className="mx-auto hidden h-full dark:block" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front-dark.svg" alt="No image" /> : null}
          <img className="mx-auto hidden h-full dark:block" src={product.images.at(0)} alt="" />
        </a>
      </div>
      <div className="pt-6">
