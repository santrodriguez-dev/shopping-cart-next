  ...
  return (
    <>
      ...
      <nav
        className={
          clsx(
            "fixed p-5 right-0 top-0 sm:w-[500px] w-full h-screen bg-white dark:bg-gray-800 z-20 shadow-2xl transform transition-all duration-300",
            {
        ...
        <button onClick={toggleSideMenu} type="button" data-drawer-hide="drawer-navigation" aria-controls="drawer-navigation" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 end-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" >
