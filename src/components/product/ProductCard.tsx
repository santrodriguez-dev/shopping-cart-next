...
export const ProductCard = ({ product }: { product: ProductItem }) => {
  ...
  const image1 = product.images.at(0)!
  const image2 = product.images.at(1)
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
      ...
      <div className="pt-6">
        ...
        <Link href={`/product/${product.id}`} className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">
          {product.title}
        </Link>
